    ...
    DO i = 1, a
        ...
        ELSE
            ...
            IF(i==1) THEN
                ...
                ! Predefine edge values of (int(eddif_y*f) dz)
                diffuse1(0) = 0.0_dp
                diffuse1(a) = 0.0_dp
            END IF
            
            ! ADD THE FOLLOWING TERM TO THE EQUATIONS:
            ...
            IF(i<a) THEN
                ...
                ! Compute pointwise value of int(eddif_y*f)dz at (i+1/2) -- this
                ! is reused later
            ...
            ! ADD THE FOLLOWING TERM TO THE MATRIX:
