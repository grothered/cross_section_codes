    ...
    SELECT CASE (grain_friction_type)
        CASE('vanrijn')
            ! Van Rijn, fully turbulent flow
             ...
             !f_g =(8._dp*g/(18._dp*log10(12._dp*max(water-bed, 20.0_dp*10.0_dp*d50)/(10._dp*d50)+0.0_dp)+0.0e+00_dp)**2)
             !CLOSEST TO WHAT VR ACTUALLY WRITES -- ACCOUNTS FOR HIS MODEL
             ! tau = 0.5*f*rho*U^2
             f_g =4.0_dp*(8._dp*g/(18._dp*log10(12._dp*max(water-bed, 20.0_dp*10.0_dp*d50)/(10._dp*d50)+0.0_dp)+0.0e+00_dp)**2)
